...
namespace OsEngine.Market.Servers.Transaq
{
    public class TransaqClient
    {
        ...
        private ConcurrentQueue<string> _newPublicMessage = new ConcurrentQueue<string>();
                ...
                try
                {
                    ...
                    if (!_newMessage.IsEmpty)
                    {
                        ...
                        if (_newMessage.TryDequeue(out data))
                        {
                            ...
                            {
                                List<Order> orders = _deserializer.Deserialize<List<Order>>(new RestResponse() { Content = data });
                            ...
                            {
                                List<Trade> myTrades = _deserializer.Deserialize<List<Trade>>(new RestResponse() { Content = data });
                ...
                try
                {
                    ...
                    if (!_newPublicMessage.IsEmpty)
                    {
                        ...
                        if (_newPublicMessage.TryDequeue(out data))
                        {
                            ...
                            {
                                List<Trade> allTrades = _deserializer.Deserialize<List<Trade>>(new RestResponse() { Content = data });
